...
public interface SlowestKey {
     ...
     * time the ith key was released. Both arrays are 0-indexed. The 0th
     * key was pressed at the time 0, and every subsequent key was
     ...
     *
     * @param releaseTimes releaseTimes.length == n
     *                     2 <= n <= 1000
     *                     1 <= releaseTimes[i] <= 109
     *                     releaseTimes[i] < releaseTimes[i+1]
     * @param keysPressed keysPressed.length == n
     *                     2 <= n <= 1000
     *                    keysPressed contains only lowercase English
     *                    letters.
     */
