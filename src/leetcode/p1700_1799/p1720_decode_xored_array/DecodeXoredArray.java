...
public interface DecodeXoredArray {
     ...
     *
     * It was encoded into another integer array encoded of length
     * n - 1, such that encoded[i] = arr[i] XOR arr[i + 1]. For example,
     ...
     *
     * @param encoded encoded.length == n - 1
     *                2 <= n <= 104
     *                0 <= encoded[i] <= 105
     * @param first 0 <= first <= 105
     */
