package org.willxu.algorithm.service.graph;

import org.willxu.algorithm.provide.graph.Node;
...
public interface CloneGraph {
     ...
     * cloned graph.
     *
     * @param node The number of nodes in the graph is in the range
     *             [0, 100].
     *             1 <= Node.val <= 100
     *             Node.val is unique for each node.
     *             There are no repeated edges and no self-loops in the
     *             graph.
