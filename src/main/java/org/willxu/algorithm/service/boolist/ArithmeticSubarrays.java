...
public interface ArithmeticSubarrays {
	 ...
	 * least two elements, and the difference between every two
	 * consecutive elements is the same. More formally, a sequence s is
	 * arithmetic if and only if s[i+1] - s[i] == s[1] - s[0] for all
	 * valid i.
	 * <p>
	 ...
	 * the i^th query is the range [l[i], r[i]]. All the arrays are
	 * 0-indexed.
	 * <p>
