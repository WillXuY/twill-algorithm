...
public interface SellDiminishingValuedColoredBalls {
	 ...
	 * represents the number of balls of the i^th color that you
	 * initially own. You are also given an integer orders, which
	 * represents the total number of balls that the customer wants.
	 ...
	 * modulo 10^9 + 7.
	 * 
	 * @param inventory 1 <= inventory.length <= 10^5
	 *                  1 <= inventory[i] <= 10^9
	 * @param orders 1 <= orders <= min(sum(inventory[i]), 10^9)
	 */
