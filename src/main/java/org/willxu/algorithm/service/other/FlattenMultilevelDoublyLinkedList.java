...
public interface FlattenMultilevelDoublyLinkedList {
    /**
     * ou are given a doubly linked list, which contains nodes that have
     * a next pointer, a previous pointer, and an additional child
     ...
     *
     * @param head The number of Nodes will not exceed 1000.
     *             1 <= Node.val <= 10^5
     */
