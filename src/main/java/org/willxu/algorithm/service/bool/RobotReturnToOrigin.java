...
public interface RobotReturnToOrigin {
     ...
     * the robot where moves[i] represents its i^th move. Valid moves
     ...
     *
     * @param moves 1 <= moves.length <= 2 * 10^4
     *              only contains the characters 'U', 'D', 'L' and 'R'.
     * @return moves to the origin.
     */
