...
public interface NumberOfDifferentIntegersInString {
     ...
     * English letters.
     *
     * You will replace every non-digit character with a space. For
     * example, "a123bc34d8ef34" will become " 123  34 8  34". Notice
     * that you are left with some integers that are separated by at
